...
.. code-block:: bash
 ...
 聽  pip3 install git+http://github.com/k7hoven/views

Or if your default python is Python 3:

.. code-block:: bash

 聽  pip install git+http://github.com/k7hoven/views
...
.. code-block:: python
 ...
 聽 聽>>> from views import gen
 聽 聽>>> list(gen[::range(3), 3, 4, ::range(5,7), 7])
    [0, 1, 2, 3, 4, 5, 6, 7]
